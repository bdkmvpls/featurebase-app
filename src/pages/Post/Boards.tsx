    ...
    <div>
      ...
      <div className="p-2 -m-2 max-h-[648px] overflow-auto custom-scrollbar-stronger space-y-1">
        <div className="flex items-center">
          <button className="flex items-center dashboard-secondary w-full px-2 py-1.5 text-foreground space-x-2 text-sm font-medium">
        ...
        <div className="flex items-center">
          <button className="bg-transparent shadow-none border-transparent dark:shadow-none dark:bg-transparent dark:border-transparent flex items-center group dashboard-secondary text-left w-full px-2 py-1.5 dark:text-foreground text-sm font-medium text-gray-500">
